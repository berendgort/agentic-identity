...
**Recent highlights:**
- AgentEdge framework: 2.76× improvement in multi-agent orchestration
...
Currently finishing my PhD in AI at Universitat Politècnica de Catalunya while exploring safer agent systems through evaluation and testing.
...
➢ Designed ActSimCrit agent planning methodology using digital twins for safe orchestration decisions  
➢ Secured MareNostrum 5 HPC allocation for large-scale transformer model training and optimization  
➢ Engineered high-performance REST API enabling real-time agent orchestration at production scale  
➢ Deployed production MLOps platform achieving 99.99% uptime with MLflow and Kubernetes  
➢ Built LLM inference pipeline scaling to 425 inferences per second using NVIDIA Triton  
➢ Optimized transformer model performance by 38.45× through Bayesian hyperparameter tuning  
➢ Led 5-person engineering team building LLM-powered autonomous agent orchestration systems

**Skills:** PyTorch · Large Language Models (LLM) · Agents · Multi-agent Systems · NVIDIA Triton · Transformers · Kubernetes · Natural Language Processing (NLP) · Artificial Intelligence (AI) · Python (Programming Language) · Docker · Deep Learning · Machine Learning · Distributed Systems · MLOps
...
### AI Research Engineer
**Columbia University in the City of New York** · Full-time  
**Jan 2022 - Dec 2022** · 1 yr  
**Location:** New York, United States · Remote

➢ Presented AAAI'23 poster on deep RL reducing backtest overfitting by 46%  
➢ Grew FinRL open-source project GitHub engagement by 214% moderating contributions  
➢ Led team deploying scalable ML pipelines using Docker and Kubernetes for big data  
➢ Reached 10,000 followers through technical articles on ML systems and optimization

**Skills:** Artificial Intelligence (AI) · Containerization · Linux · Machine Learning · Deep Learning · Large Language Models (LLM) · Google Cloud Platform (GCP) · Problem Solving · PyTorch · Deep Reinforcement Learning · Docker · Kubernetes · Google Cloud · Git · MLOps
...
➢ Reduced control error by 86% through design enhancements in robotic optical terminal  
➢ Developed laser communication system for LEO satellites enabling 1+ Tbps speeds  
➢ Led cross-functional re-engineering effort reducing robotic terminal costs by 28%

**Skills:** Artificial Intelligence (AI) · MATLAB · Mathematics · Problem Solving · Systems Engineering · Control Systems Design · Robotics
...
**Swiss Plasma Center at EPFL** · Internship  
**Nov 2018 - Apr 2019** · 6 mos  
**Location:** Lausanne Area, Switzerland

➢ Redesigned robotic control system reducing control error by 91%  
➢ Awarded full internship scholarship by FuseNet for fusion energy research  
➢ Collaborated with six physicists and engineers on TCV Fusion Reactor control systems  
➢ Developed microwave beam control system directing 4.5MW into plasma for reactor heating

**Skills:** MATLAB · Mathematics · Problem Solving · Systems Engineering · Robotics · Control Systems Design
...
➢ Researching transformer models and attention mechanisms for efficient inference systems  
➢ Publishing on agent systems, model compression, and production ML optimization  
➢ Developing multi-agent orchestration frameworks with evaluation methodologies  
➢ Advancing techniques for safe and reliable LLM-powered autonomous systems

**Skills:** Problem Solving · Natural Language Processing (NLP) · Mathematics
...
➢ Graduated magna cum laude with full scholarship for academic excellence  
➢ Achieved 10.0/10.0 thesis grade on deep reinforcement learning for sequential decision-making  
➢ Coursework highlights: Neural Networks (9.8) • Deep Learning (9.8) • Machine Learning (9.5)

**Skills:** Linux · Machine Learning · Problem Solving · Natural Language Processing (NLP) · Artificial Intelligence (AI) · Java · Mathematics · C++
...
➢ Thesis on torque ripple minimization using repetitive control and optimization algorithms  
➢ Specialized in control systems with focus on mathematical modeling and numerical optimization  
➢ Top coursework: System Theory (9.0) • Scientific Computing (8.0) • Control Engineering (8.0)

**Skills:** Linux · Problem Solving · Artificial Intelligence (AI) · Mathematics · MATLAB
...
➢ Reduced quadcopter propeller noise by 85% through aerodynamic design optimization  
➢ Designed and 3D printed universal propeller solution applicable to any quadcopter platform

**Skills:** Problem Solving · Mathematics · MATLAB
...
**IEEE Transactions on Machine Learning in Communications and Networking** · Mar 1, 2025
...
**IEEE Communications Magazine** · Oct 22, 2024
...
**Association for the Advancement of Artificial Intelligence (AAAI)** · Dec 16, 2022
...
**girafe-ai🦒 founder; Head of ML at Yandex AI Lab**  
**Managed Berend directly** · March 31, 2022
...
**Managed Berend directly** · February 21, 2019
